...
describe("Coordinate Transformation Tests", function () {
    ...
    it("getMercatorTileBounds #1", function () {
        let bound: MercatorBoundingBox = proj.getMercatorTileBounds({ x: 0, y: 0 }, 1);
    ...
    it("getMercatorTileBounds #2", function () {
        let bound: MercatorBoundingBox = proj.getMercatorTileBounds({ x: 5083, y: 11188 }, 14);
        expect(bound).to.have.property("leftbottom");
        expect(bound).to.have.property("righttop");
    ...
    it("getWGS84TileBounds #1", function () {
        let bound: WGS84BoundingBox = proj.getWGS84TileBounds({ x: 0, y: 0 }, 1);
        expect(bound).to.have.property("leftbottom");
        expect(bound).to.have.property("righttop");
    ...
    it("getWGS84TileBounds #2", function () {
        let bound: WGS84BoundingBox = proj.getWGS84TileBounds({ x: 272, y: 177 }, 9);
        expect(bound).to.have.property("leftbottom");
        expect(bound).to.have.property("righttop");
    ...
    it("getWGS84TileBounds #3", function () {
        let bound: WGS84BoundingBox = proj.getWGS84TileBounds({ x: 4383, y: 2854 }, 13);
        expect(bound).to.have.property("leftbottom");
        expect(bound).to.have.property("righttop");
    ...
    it("getWGS84TileBounds #4", function () {
        let bound: WGS84BoundingBox = proj.getWGS84TileBounds({ x: 5, y: 10 }, 10);
        expect(bound).to.have.property("leftbottom");
        expect(bound).to.have.property("righttop");
    ...
    it("getWGS84TileCenter #1", function () {
        let center: Wgs84 = proj.getWGS84TileCenter({ x: 0, y: 0 }, 0);
    ...
    it("getWGS84TileCenter #2", function () {
        let center: Wgs84 = proj.getWGS84TileCenter({ x: 4383, y: 2854 }, 13, 256);
        expect(center).to.have.property("lng");
        expect(center).to.have.property("lat");
